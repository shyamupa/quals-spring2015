...
\begin{frame}{Top-Down Construction of Gumbel Process}
  ...
  \begin{figure} 
    ...
    \begin{tikzpicture}[scale=0.8]
      ...
      \path[draw,black,ultra thick] (-5,0)--(5,0);

      \path[draw,red,thick] (2.5,0) -- (2.5,4.5) circle (1.5pt);
      \node[below] at (2.5,0) {$X_1$};
      \node[below] at (0.5,0) {\color{gray}{\tiny{B1}}};
      \node[below] at (4.0,0) {\color{gray}{\tiny{B1}}};
      
      \path[draw,red,thick] (-2.0,0) -- (-2.0,3.5) circle (1.5pt);
      \node[below] at (-2.0,0) {$X_2$};
      
      \path[draw,red,thick] (3.0,0) -- (3.0,-3.5) circle (1.5pt);
      \node[above] at (3.0,0) {$X_3$};
    \end{tikzpicture}
  \end{figure}
\end{frame}
