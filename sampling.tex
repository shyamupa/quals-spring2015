...
\begin{frame}[label=framelabel]{Gumbel Distribution}
  ...
  \end{itemize}
        ...
        \begin{tikzpicture}[scale=0.8] % plotting with data in columns
          \begin{axis}[
              ...
              extra x tick style={    % Set styles that only apply to the extra tick
                ...
                xticklabels={mean of gaussian/ mode of gumbel}, % Set the label text
      ...
      %% \begin{tikzpicture}
      %%   \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.5\textwidth]{images/gumbel_4.png}};
