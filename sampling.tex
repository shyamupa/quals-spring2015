...
\begin{frame}{Benefits} %{Wait ... So What?}
  ...
  \begin{itemize}
  \item Partition Function evaluation $\implies$ Computing (many) perturbed MAPs. % No need to compute the partition function, as long as you can compute the (perturbed) argmax!
