...
\begin{frame}{The Problem}
  ...
  \begin{exampleblock}{Example}
      The {\color<2->{red} battle}\only<3->{$\implies Battle of Trafalgar$} was the most decisive naval victory of the {\color<2->{red}war}\only<3->{$\implies Napoleanic Wars$}. The British led by Admiral Lord Nelson defeated the French off the coast of Spain. Nelson succumbed to his injuries in battle.
      \end{exampleblock}
  \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
