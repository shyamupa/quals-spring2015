...
\begin{frame}{Motivation of the Paper}
  ...
  %% \onslide<2->{
  %%   No explanation in the original papers! \\
  %% }
\end{frame}

\begin{frame}{Why is this Useful?}
  \onslide<1->{
    %% This paper claims to that their explicitly model the properties needed for achieving the above effect.
  ...
  \onslide<2->{
    ...
    \end{center}
    \begin{align*} 
    \min_x \|x - (king - man + woman)\|^2
    \end{align*}
  }
\end{frame}
%%   Global Matrix Factorization Methods are prone to ill-effects of predominance of function words.
%% \begin{frame}{Claim}
%% This paper claims that their objective explicitly models the properties needed for achieving the above effect.
%% \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
